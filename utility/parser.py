...
def parse_args():
    parser = argparse.ArgumentParser(description="Run DVGCL.")
    ...
    parser.add_argument('--t_size', type=int, default=1, help='t size.')
    parser.add_argument('--emb_reg', type=float, default=1e-05, help='Regularizations.')
    parser.add_argument('--int_reg', type=float, default=1e-05, help='Regularizations.')
    parser.add_argument('--ssl_reg', type=float, default=0.4, help='Reg weight for ssl loss')
    parser.add_argument('--kl_reg', type=int, default=0.01, help='Reg weight for kl loss.')
    parser.add_argument('--n_layers', type=int, default=2, help='GCN layer numbers.')
    parser.add_argument('--n_intents', type=int, default=512, help='Number of latent intents')
